-- Final safe migration: Skip everything that already exists
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'at_least_one_best_for') THEN
...
-- Success message
SELECT 'Best For system migration completed successfully!' as message;
